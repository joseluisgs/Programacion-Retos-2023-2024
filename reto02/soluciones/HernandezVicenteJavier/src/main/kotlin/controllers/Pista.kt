...
private const val NUM_PILOTO = 8
private const val DISTANCIA = 10
/**
 ...
 */
object Pista{
    val pista = Array(NUM_PILOTO){ arrayOfNulls<Piloto>(DISTANCIA)}
     ...
     */
    private fun inicializarPista(pista: Array<Array<Piloto?>>): Array<Array<Piloto?>> {
     ...
     */
   private fun printPista(pista: Array<Array<Piloto?>>){
