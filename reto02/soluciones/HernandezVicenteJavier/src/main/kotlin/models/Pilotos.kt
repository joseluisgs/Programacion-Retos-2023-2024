...
abstract class Pilotos(
     ...
     */
   open fun moverse(pistaMatriz: Array<Array<Pilotos?>>): Array<Array<Pilotos?>> {
     ...
     */
    fun colocarPiloto(pista: Array<Array<Pilotos?>>): Array<Array<Pilotos?>> {
