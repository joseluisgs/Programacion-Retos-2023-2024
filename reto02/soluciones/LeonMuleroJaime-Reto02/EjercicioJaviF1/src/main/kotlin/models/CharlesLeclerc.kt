...
/**
 * Clase para el piloto Charles Leclerc
 ...
 * @see Piloto
 */
class CharlesLeclerc (
    nombre: String = "Leclerc",
    siglas: String = "LEC",
    emoticono: String = "🏎️",
    posibilidadAccidente:Int = 1,
    tiempo: Int = 0,
    vuelta: Int = 1,
    finMovement: Boolean = false,
    meta:Boolean = false,
    contadorPitStop: Int = 0
) : Piloto(nombre, siglas, emoticono, posibilidadAccidente, tiempo, vuelta, finMovement, meta, contadorPitStop), Ferrari {
}