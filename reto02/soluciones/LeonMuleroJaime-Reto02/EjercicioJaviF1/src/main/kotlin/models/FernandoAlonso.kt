...
/**
 * Clase para el piloto Fernando Alonso
...
) : Piloto(nombre, siglas, emoticono, posibilidadAccidente, tiempo, vuelta, finMovement, meta, contadorPitStop), AstonMartin {
}