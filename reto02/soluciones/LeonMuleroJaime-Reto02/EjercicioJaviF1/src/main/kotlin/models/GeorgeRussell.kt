...
/**
 * Clase para el piloto George Russell
...
class GeorgeRussell (
    ...
    siglas: String = "RUS",
    emoticono: String = "🏎️",
    posibilidadAccidente:Int = 3,
    tiempo: Int = 0,
    vuelta: Int = 1,
    finMovement: Boolean = false,
    meta:Boolean = false,
    contadorPitStop: Int = 0
) : Piloto(nombre, siglas, emoticono, posibilidadAccidente, tiempo, vuelta, finMovement, meta, contadorPitStop), Mercedes {
}