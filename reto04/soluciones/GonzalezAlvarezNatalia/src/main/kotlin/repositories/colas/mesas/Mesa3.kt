...
/**
 * Clase que representa la mesa 3 del restaurante.
 *
...
class Mesa3(
    ...
    private val columna: Int = 2
) : Queue<Cliente> {
    /**
     * Lista mutable que almacena a los clientes sentados en la mesa.
     */
    private val mesa3 = mutableListOf<Cliente>()
